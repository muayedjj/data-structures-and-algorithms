...
def test_zip_lists(create_list_one, create_list_two):
    ...
    actual = str(zip_lists(create_list_one, create_list_two))
...
def test_one_shorter(list_one_short, create_list_two):
    ...
    actual = str(zip_lists(list_one_short, create_list_two))
...
def test_two_shorter(create_list_one, list_two_short):
    ...
    actual = str(zip_lists(create_list_one, list_two_short))
...
def test_one_empty(list_one_empty, create_list_two):
    ...
    actual = str(zip_lists(list_one_empty, create_list_two))
...
def test_two_empty(create_list_one, list_two_empty):
    ...
    actual = str(zip_lists(create_list_one, list_two_empty))
